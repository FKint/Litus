...
use OgoneBundle\Test\Component\ParameterTransformer\SimpleTestConfiguration;
use OgoneBundle\Test\Component\ParameterTransformer\SimpleOrder;
use OgoneBundle\Component\ParameterTransformer\ParameterTransformer;

/**
 * @author Daan Wendelen <daan.wendelen@litus.cc>
 */
class ParameterTransformerTest extends \PHPUnit_Framework_TestCase
{
    public function testGenerateFormWithAllParameters()
    {
        ...
        $ogone = new ParameterTransformer($configuration);
